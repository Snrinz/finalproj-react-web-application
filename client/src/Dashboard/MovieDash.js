  ...
  const headCells = [
    { id: 'photo', numeric: false, disablePadding: false, label: 'Image' },
  ...
  export default function EnhancedTable() {
    ...
    const handleOpen = (event, name) => {
      setOpen(true);
      let index = data.findIndex(function(movie){
        return movie.name === name
      })
      setIndexSelected(index)      

      console.log("Movie: " + data[indexSelected].name);
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">                        
                          <IconButton onClick={(event) => handleOpen(event, row.name)} className={classes.iconButton} aria-label="search">
                              <EditIcon />
                          </IconButton>
                        </TableCell>
                      </TableRow>
