...
export default function Homepage() {
    ...
    const [moviemostrating, setmoviemostrating] = useState({
        moviemostrating: [],
        isLoad: true
    })
    ...
    useEffect(() => {
        ...
        .then(res =>{ 
            ...
            setmoviemostrating({moviemostrating:res.movies, isLoad:false})
        })
        .catch(err => {
                        ...
                        :
                            <div style={{display: 'flex', alignItems: 'center'}}>
                                <div className="trend-movie-section">
                                    <React.Fragment>
                                        {
                                            moviemostrating.moviemostrating &&  moviemostrating.moviemostrating.map(movie => (
                                                <MovieCard key={movie._id} movie={movie} />
                                            ))
                                        }
                                    </React.Fragment>
